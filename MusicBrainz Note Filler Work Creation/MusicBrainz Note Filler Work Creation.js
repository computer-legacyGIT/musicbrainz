// ==UserScript==
// @name         MusicBrainz - Work Creation Edit Note Button
// @namespace    https://musicbrainz.org/
// @version      1.0
// @description  Adds a button to the release relationships editor to allow for a preset edit note when creating work entities
// @author       ClaudeCode
...
(function () {
    ...
    const EDIT_NOTE = `Works created from the release relationships editor screen. I have done my best to identify works correctly and where possible identify the language of the work used; this is often achieved by listening to the recording or by reviewing printed lyric content within the packaging. The release MBID is ${mbid}`;
    ...
    function addEditNoteButton() {
        ...
        if (document.getElementById('mb-edit-note-btn')) return;

        const btn = document.createElement('button');
        btn.id = 'mb-edit-note-btn';
        btn.type = 'button';
        btn.textContent = '✏️ Create Work';
